...
import org.galilelj.net.discovery.HttpDiscovery;
import org.galilelj.params.*;
import org.galilelj.script.Script;
import org.galilelj.script.ScriptBuilder;
import org.galilelj.script.ScriptChunk;
...
import org.galilelj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.galilel.regtest";
    ...
    public static final int TARGET_TIMESPAN = CoinDefinition.TARGET_TIMESPAN; // 1 minute per difficulty cycle, on average.
    public static final int TARGET_SPACING = CoinDefinition.TARGET_SPACING;   // 1 minute seconds per block.
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.galilelj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.galilelj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.galilelj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.galilelj.core.AlertMessage}s. You can use {@link org.galilelj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
