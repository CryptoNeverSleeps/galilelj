...
import org.galilelj.net.StreamConnection;
import org.galilelj.store.BlockStore;
import org.galilelj.store.BlockStoreException;
import org.galilelj.utils.ListenerRegistration;
 ...
 * {@link org.galilelj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.galilelj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.galilelj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.galilelj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.galilelj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        {
            // todo mbroemme: commented for now.
            ...
            // todo mbroemme: check galilel masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // galilelj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    protected void processTransaction(final Transaction tx) throws VerificationException {
        ...
        try {
            ...
            // GALI Specific
            // todo mbroemme: commented dash instantSend for now.
            if (context.instantSend!=null)
    ...
    protected void processBlock(Block m) {
        ...
        try {
            ...
            if (blockChain.add(m)) {
                ...
                lock.lock();
                try {
                    //todo: mbroemme check this please..
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.galilelj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.galilelj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.galilelj.core.Peer#ping()} has never
