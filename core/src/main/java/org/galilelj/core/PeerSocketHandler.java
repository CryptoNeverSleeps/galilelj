...
import org.galilelj.net.AbstractTimeoutHandler;
import org.galilelj.net.MessageWriteTarget;
 ...
 * {@link org.galilelj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.galilelj.net.NioClient} or
     * {@link org.galilelj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
