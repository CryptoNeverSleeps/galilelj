 ...
 * the lightweight SPV mode, a {@link org.galilelj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.galilelj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            if (storedPrev == null) {
                ...
                //todo mbroemme: i'm not checking the difficulty yet
    ...
    private void checkDifficultyTransitions_V1(StoredBlock storedPrev, Block nextBlock) throws BlockStoreException, VerificationException {
        ...
        if ((storedPrev.getHeight() + 1) % params.getInterval() != 0) {
            ...
            if (nextBlock.getDifficultyTarget() != prev.getDifficultyTarget()) {
                //todo: mbroemme: check difficulty transition commented.
