...
import org.galilelj.net.*;
import org.galilelj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of galilelj fixes the known
     ...
     * {@link org.galilelj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.galilelj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.galilelj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.galilelj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.galilelj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.galilelj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.galilelj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.galilelj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.galilelj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a galilelj based app running in SPV mode to fully validating security.
     */
