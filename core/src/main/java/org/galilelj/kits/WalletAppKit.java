...
import org.galilelj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV galilelj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit galilelj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing galilelj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initGalilel(false, true);
     ...
     * {@link org.galilelj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the galilelj website for further details.
     */
