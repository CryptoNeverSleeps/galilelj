...
package org.galilelj.script;

import org.galilelj.core.*;
import org.galilelj.crypto.TransactionSignature;
...
import static org.galilelj.script.ScriptOpCodes.*;
...
public class Script {
     ...
     *
     * <p>galilelj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
     ...
     * {@link org.galilelj.core.TransactionInput#verify(org.galilelj.core.TransactionOutput)} or
     * {@link org.galilelj.script.Script#correctlySpends(org.galilelj.core.Transaction, long, Script)}. This method
     * is useful if you need more precise control or access to the final state of the stack. This interface is very
     * likely to change in future.
     *
     * @deprecated Use {@link #executeScript(org.galilelj.core.Transaction, long, org.galilelj.script.Script, java.util.LinkedList, java.util.Set)}
     * instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #correctlySpends(org.galilelj.core.Transaction, long, org.galilelj.script.Script, java.util.Set)}
    ...
    /**
     * Get the {@link org.galilelj.script.Script.ScriptType}.
