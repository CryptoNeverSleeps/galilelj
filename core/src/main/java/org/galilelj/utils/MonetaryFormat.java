...
import org.galilelj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the GALI denomination. */
    public static final MonetaryFormat GALI = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mGALI denomination. */
    public static final MonetaryFormat MGALI = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µGALI denomination. */
    public static final MonetaryFormat UGALI = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 GALI. */
    public static final String CODE_GALI = "GALI";
    /** Currency code for base 1/1000 GALI. */
    public static final String CODE_MGALI = "mGALI";
    /** Currency code for base 1/1000000 GALI. */
    public static final String CODE_UGALI = "µGALI";
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard GALI notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_GALI;
        this.codes[3] = CODE_MGALI;
        this.codes[6] = CODE_UGALI;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.galilelj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.galilelj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
