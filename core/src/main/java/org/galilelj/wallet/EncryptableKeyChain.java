...
import org.galilelj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.galilelj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.galilelj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.galilelj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
