...
/**
 * <p>A KeyChainGroup is used by the {@link org.galilelj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.galilelj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.galilelj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.galilelj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
