...
import org.galilelj.core.*;
import org.galilelj.core.Message;
import org.galilelj.core.listeners.*;
import org.galilelj.core.TransactionConfidence.*;
import org.galilelj.crypto.*;
import org.galilelj.script.*;
import org.galilelj.signers.*;
import org.galilelj.utils.*;
import org.galilelj.wallet.Protos.Wallet.*;
import org.galilelj.wallet.WalletTransaction.*;
import org.galilelj.wallet.listeners.KeyChainEventListener;
import org.galilelj.wallet.listeners.ScriptsChangeEventListener;
import org.galilelj.wallet.listeners.WalletChangeEventListener;
import org.galilelj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.galilelj.wallet.listeners.WalletCoinsSentEventListener;
import org.galilelj.wallet.listeners.WalletEventListener;
import org.galilelj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.galilelj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_GALI_ONLY? 1 : 0;
     ...
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.galilelj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.galilelj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.galilelj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.galilelj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.galilelj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.galilelj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.galilelj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.galilelj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of galilelj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.galilelj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.galilelj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.galilelj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.galilelj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.galilelj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.galilelj.crypto.KeyCrypter,
     ...
     * {@link org.galilelj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.galilelj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.galilelj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.galilelj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.galilelj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.galilelj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
