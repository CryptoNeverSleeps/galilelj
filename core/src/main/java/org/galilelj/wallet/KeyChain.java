...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.galilelj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the galilelj protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.galilelj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
