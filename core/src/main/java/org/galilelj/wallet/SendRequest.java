...
import org.galilelj.wallet.KeyChain.KeyPurpose;
import org.galilelj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.galilelj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.galilelj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
