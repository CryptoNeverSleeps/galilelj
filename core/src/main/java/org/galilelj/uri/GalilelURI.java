...
import org.galilelj.params.AbstractBitcoinNetParams;
...
public class GalilelURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.galilelj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.galilelj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new GalilelURI from the given string. Can be for any network.
     *
     ...
     */
    public GalilelURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public GalilelURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("GalilelURI[");
        boolean first = true;
