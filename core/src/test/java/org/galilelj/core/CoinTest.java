...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 GALI", COIN.toFriendlyString());
        assertEquals("1.23 GALI", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 GALI", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 GALI", valueOf(1, 23).negate().toFriendlyString());
    }
