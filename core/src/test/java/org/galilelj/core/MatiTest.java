...
public class MatiTest {
    ...
    public void connectTestnetPeer(){
        ...
        Peer peer = new Peer(networkParameters,versionMessage,new PeerAddress("mobile.testnet.galilel.cloud", 56123), null);
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_GALI_ONLY
        );
    ...
    public Wallet restore(NetworkParameters networkParameters) throws IOException {
        String filename = "3.1.2_galilel-wallet-backup_org.galilel.production-2019-01-23";
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_GALI_ONLY);
    ...
    public void syncWatchingKey() throws IOException, BlockStoreException {
        ...
        //Wallet watchingWallet = Wallet.fromWatchingKeyB58(params,pubKey,0, DeterministicKeyChain.KeyChainType.BIP44_GALI_ONLY);
        //DeterministicKey xpubKey2 = watchingWallet.getWatchingKey();
        ...
        peerGroup.addPeerDiscovery(new PeerDiscovery() {
            ...
            public InetSocketAddress[] getPeers(long services, long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
                return new InetSocketAddress[] {
                    new InetSocketAddress("mobile.testnet.galilel.cloud", 56123)
                };
            }
