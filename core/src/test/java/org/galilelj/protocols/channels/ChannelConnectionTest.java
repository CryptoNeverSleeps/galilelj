...
import org.galilelj.testing.TestWithWallet;
...
import static org.galilelj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.galilelj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.galilelj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
