...
import org.galilelj.core.AbstractBlockChain;
...
import org.galilelj.core.PeerAddress;
...
import org.galilelj.core.VerificationException;
import org.galilelj.core.TransactionConfidence.ConfidenceType;
import org.galilelj.crypto.*;
import org.galilelj.script.Script;
import org.galilelj.script.ScriptBuilder;
import org.galilelj.signers.StatelessTransactionSigner;
import org.galilelj.signers.TransactionSigner;
import org.galilelj.store.BlockStoreException;
import org.galilelj.store.MemoryBlockStore;
import org.galilelj.testing.*;
import org.galilelj.utils.ExchangeRate;
import org.galilelj.utils.Fiat;
import org.galilelj.utils.Threading;
import org.galilelj.wallet.Wallet.BalanceType;
import org.galilelj.wallet.WalletTransaction.Pool;
...
import org.galilelj.wallet.Protos.Wallet.EncryptionType;
...
import static org.galilelj.core.Utils.HEX;
import static org.galilelj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0; // Break the signature: galilelj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("galilelj-unit-test", null);
