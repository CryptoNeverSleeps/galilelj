...
import org.galilelj.protocols.payments.PaymentProtocol;
import org.galilelj.protocols.payments.PaymentProtocolException;
import org.galilelj.protocols.payments.PaymentSession;
import org.galilelj.script.ScriptBuilder;
import org.galilelj.store.*;
import org.galilelj.uri.GalilelURI;
import org.galilelj.uri.BitcoinURIParseException;
import org.galilelj.utils.BriefLogFormatter;
import org.galilelj.wallet.DeterministicSeed;
import org.galilelj.wallet.DeterministicUpgradeRequiredException;
import org.galilelj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.galilelj.core.listeners.BlocksDownloadedEventListener;
import org.galilelj.core.listeners.DownloadProgressTracker;
import org.galilelj.wallet.MarriedKeyChain;
import org.galilelj.wallet.Protos;
import org.galilelj.wallet.SendRequest;
import org.galilelj.wallet.Wallet;
import org.galilelj.wallet.WalletExtension;
...
import static org.galilelj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    GalilelURI paymentRequestURI = new GalilelURI(location);
